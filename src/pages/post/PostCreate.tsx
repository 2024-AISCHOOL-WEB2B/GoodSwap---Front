  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
        ...
        <div className="w-[712px] h-[539px] static">
         ...
         <div className="text-[#292c33] text-center font-['Inter-Regular',_sans-serif] text-[13px] font-normal absolute left-[calc(50%_-_-38px)] top-[calc(50%_-_353px)] w-[27px] h-[18px] flex items-center justify-center">
          가격
         </div>
