...
import { isAuthenticatedAtom, loginAtom, logoutAtom } from '../features/auth/atoms/auth';
...
function App() {
    ...
    return (
        <Routes>
            <Route path="/" element={<MainPage isLoggedIn={isAuthenticated} onLogout={handleLogout} />} />
            <Route path="/login" element={<LoginForm onLogin={handleLogin} />} />
            <Route path="/main" element={<MainPage isLoggedIn={isAuthenticated} onLogout={handleLogout} />} />
