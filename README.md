...
이 프로젝트는 웹개발을 막시작한 햇병아리가 작성한 문서이기 때문에 수많은 내용들이 오류가 있거나 전문가들이 보시기에 부족한 내용이 있을 수 있음을 미리 알려드리오니 그 점 감안해주시고 읽어주시기를 부탁합니다. 틀린 내용이나 첨언하실 내용이 있다면 피드백 언제나 적극 환영입니다. 감사합니다.
...
- 이 프로젝트는 Vite를 빌드 도구로 사용하여 빠른 개발 속도와 핫 모듈 리플레이스먼트(HMR)를 제공합니다.
